...
lme_params <- tribble(
  ...
  "Rice and Gislason", 2006, "Trawl survey of North Sea Fish + multi-species virtual pop. analysis", "ln
abundance within a size interval to ln size interval, says 10cm later", "not stated", "not stated",
  
  "Daan", 2005, "North Sea fisheries independent trawl surveys", "5 & 10cm bins, ln(cpue) within bins", 
