...
ggplot() +
  geom_line(
    ...
    aes(est_year, b, color = "Wigley, No Spiny Dogfish")) +
  geom_line(
    data = mutate(wigley_bmspectra, survey_area = factor(survey_area, levels = area_levels)),
    aes(est_year, b, color = "All Wigley Species")) +
  scale_color_brewer(palette = "Set1") +
  facet_grid(survey_area~fct_rev(season)) +
  labs(x = "Year",
       y = "Exponent of Size Spectra",
       title = "Shift in Spectra with Exclusion of Spiny Dogfish")
