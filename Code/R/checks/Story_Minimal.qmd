...
```{r}
###
# # Load the stupid image
# # library(magick)
# df_img <- magick::image_read(here::here("Data/phylopics/squalus_phylopic.png"))




# Separate axes for 90
quants_90 <- wigley_season_qs %>% filter(Percentile == "90%") %>% mutate(Percentile = "90th Percentile")
spiny_90 <-  spiny_season_qs %>% filter(Percentile == "90%") %>% mutate(Percentile = "90th Percentile")


library(ggimage)

# dogfish locations - use the data
