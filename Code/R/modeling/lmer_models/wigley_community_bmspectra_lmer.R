...
# Drop NA's
wtb_model_df <- drop_na(wigley_lenspectra_df, total_weight_lb, bot_temp, b) %>% 
...
#   ggpredict(wig_wtb_mod, ~ yr_num + survey_area) )
# 
...
ggsave(
  ...
  filename = here::here("Figs/small_community/sc_wtb_regionseason_emmeans.png"))
