...
# Stack them
(len_mean_p / len_trends_p) + plot_layout(guides = "collect") & theme(legend.position = "bottom")
```
...
# Stack them
(lenb_mean_p / lenb_trends_p) + plot_layout(guides = "collect")  & theme(legend.position = "bottom")
```
...
# Stack them
(wt_mean_p / wt_trends_p) + plot_layout(guides = "collect")  & theme(legend.position = "bottom")
```
...
# Stack them
(wtb_mean_p / wtb_trends_p) + plot_layout(guides = "collect")  & theme(legend.position = "bottom")
```
